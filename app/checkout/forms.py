...
class CheckoutForm(FlaskForm):
    ...
    expyear = StringField('Godina_Isteka', validators=[DataRequired("Ovo polje je neophodno."), Length(min=4, max=5, message="Godina isteka mora biti između %(min)d i %(max)d znakova duga.")])
